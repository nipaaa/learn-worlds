      ...
      <div className="container ">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
          <div>
            ...
            <p className="text-[#444444] py-12">
              An LMS gives you the ability to track the  progress of learnersin
              the  <br/>course material. More precisely, you can track their
              understanding.
            </p>
            <div className="flex gap-12  items-center mb-8">
            {
                database.map((data,index)=><div className="flex flex-col gap-y-3" key={index}>
                    <img src={data.picture} alt=""/>
                    <p className="text-[20px] text-[#31374D] font-bold">{data.amount} + </p>
                    <p className="text-[16px] text-[rgba(68, 68, 68, 0.85)]">{data.title}</p>
                </div>)
            }
            </div>
